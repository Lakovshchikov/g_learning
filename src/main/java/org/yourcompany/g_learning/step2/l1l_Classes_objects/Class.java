...
class Flower {
    ...
    void rastEt(){
        System.out.println( title + " - rastet");
    }
}
...
public class Class {
    public static void main (String[] args) {
        ...
        // у цветочка должен быть метод растет и поле высота
        // при вызове метода высота тветочка должна увеличиваться на n
        // пример
        // Flower flower = new Flower();
        // flower.height = 10;
        // System.out.print(flower.height) // 5
        // flower.grow(5)
        // System.out.print(flower.height) // 10
    }
